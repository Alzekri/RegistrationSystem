...
<template>
  ...
  <div class="row text-center mt-3">
    <div class="col-3">
      <button class="col-6 px-3 btn btn-danger" @click="addnew = true">
        <FIcons class="icon me-4" :icon="['fas', 'user']" />Delete All Students
      </button>
    </div>
    <div class="dropdown col-3 divdrdropdown">
      <button
        type="button"
    ...
    <div class="col-3">
      <button class="col-6 px-3 btn btn-info" @click="addnew = true">
        <FIcons class="icon me-4" :icon="['fas', 'user']" />Add New Student
      </button>
    </div>
  </div>
  <hr />
